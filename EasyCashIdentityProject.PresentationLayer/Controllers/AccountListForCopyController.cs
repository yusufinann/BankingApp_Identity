...
namespace EasyCashIdentityProject.PresentationLayer.Controllers
{
    public class AccountListForCopyController : Controller
    {
        ...
        private readonly UserManager<AppUser> _userManager; //sisteme authanticate olan kullanıcıyı almak için
        ...
        {
            var user = await _userManager.FindByNameAsync(User.Identity.Name);  //sisteme authanticate olan kullanıcıyı yakaladım.
